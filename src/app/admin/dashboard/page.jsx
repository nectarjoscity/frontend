...
export default function AdminDashboardPage() {
  ...
  const Stat = ({ title, value, delta, accent }) => (
    <Card>
      <div className="text-sm font-medium mb-2" style={{ color: colors.mutedText }}>{title}</div>
      <div className="text-2xl font-bold" style={{ color: colors.text }}>{value}</div>
      {delta && <div className="text-xs mt-1" style={{ color: accent || colors.green600 }}>{delta}</div>}
    </Card>
  );

  return (
    <AdminLayout title="Overview" active="dashboard">
        <div className="max-w-7xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:col-span-12">
            <div className="relative overflow-hidden rounded-2xl p-4" style={{ background: colors.amber500, border: `1px solid ${colors.amber500}` }}>
              <div className="flex items-center gap-2 text-sm font-medium mb-1" style={{ color: '#fff' }}>
                <IoReceiptOutline className="h-4 w-4" />
                <span>Total Orders</span>
              </div>
              <div className="text-3xl font-extrabold" style={{ color: '#fff' }}>1250</div>
              <div className="text-xs mt-1" style={{ color: 'rgba(255,255,255,0.9)' }}>+10% Since last month</div>
              <div className="absolute -right-10 -bottom-10 h-24 w-24 rounded-full opacity-25" style={{ background: '#fff' }} />
            </div>
            <Card>
              <div className="flex items-center gap-2 text-sm font-medium mb-2" style={{ color: colors.mutedText }}>
                <IoCubeOutline className="h-4 w-4" />
                <span>Total Delivered</span>
              </div>
              <div className="text-2xl font-bold" style={{ color: colors.text }}>1070</div>
              <div className="text-xs mt-1" style={{ color: colors.green600 }}>+7.5% Since last month</div>
            </Card>
            <Card>
              <div className="flex items-center gap-2 text-sm font-medium mb-2" style={{ color: colors.mutedText }}>
              ...
              <div className="text-2xl font-bold" style={{ color: colors.text }}>180</div>
              <div className="text-xs mt-1" style={{ color: colors.red600 }}>-3.5% Since last month</div>
            </Card>
            <Card>
              <div className="flex items-center gap-2 text-sm font-medium mb-2" style={{ color: colors.mutedText }}>
              ...
              <div className="text-2xl font-bold" style={{ color: colors.text }}>$15750</div>
              <div className="text-xs mt-1" style={{ color: colors.green600 }}>+7.5% Since last month</div>
            </Card>
          </div>
          ...
          <div className="lg:col-span-7 grid gap-4">
            <Card>
              <div className="flex items-center justify-between mb-2">
                <div className="text-sm font-semibold" style={{ color: colors.text }}>Outlets Operational Cost Vs Revenue</div>
                <div className="text-xs" style={{ color: colors.mutedText }}>Weekly</div>
              </div>
              <div className="h-56 relative rounded-lg overflow-hidden" style={{ background: theme === 'light' ? '#F9FAFB' : '#0B1220', border: `1px dashed ${colors.cardBorder}` }}>
                ...
                <div className="absolute top-2 left-2 text-[10px]" style={{ color: colors.mutedText }}>$3500 Revenue</div>
              </div>
            </Card>
            <Card>
              <div className="text-sm font-semibold mb-3" style={{ color: colors.text }}>Top Categories Item</div>
                ...
                {categories.slice(0,4).map((c, idx) => (
                  <div key={c._id} className="rounded-xl overflow-hidden" style={{ background: colors.background, border: `1px solid ${colors.cardBorder}` }}>
                    ...
                    <div className="p-2">
                      ...
                      <div className="text-xs" style={{ color: colors.mutedText }}>{[65,45,81,38][idx % 4]}%</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-5 grid gap-4">
            <Card>
              <div className="text-sm font-semibold mb-2" style={{ color: colors.text }}>Trending Menu Item</div>
              <div className="rounded-xl overflow-hidden mb-3 h-40" style={{ background: theme === 'light' ? '#FFE4E6' : '#3F1D1D' }} />
              <div className="text-sm font-semibold" style={{ color: colors.text }}>Fish & Chips (British classic)</div>
              <div className="flex items-center gap-4 text-xs mt-1" style={{ color: colors.mutedText }}>
                <span className="inline-flex items-center gap-1"><IoStar className="h-3 w-3" /> 4.6</span>
                <span className="inline-flex items-center gap-1"><IoEyeOutline className="h-3 w-3" /> 420</span>
                <span className="ml-auto text-base font-bold" style={{ color: colors.text }}>$12</span>
              </div>
            </Card>
            <Card>
              <div className="text-sm font-semibold mb-2" style={{ color: colors.text }}>POS Activities</div>
              <div className="text-2xl font-bold mb-2" style={{ color: colors.text }}>$1550</div>
              <div className="grid grid-cols-3 gap-2 text-xs" style={{ color: colors.mutedText }}>
                <div className="p-2 rounded-lg flex flex-col gap-1" style={{ background: theme === 'light' ? '#F3F4F6' : '#1F2937' }}>
                  <div className="inline-flex items-center gap-1"><IoReceiptOutline className="h-3 w-3" /> Total Bills</div>
                  <div className="font-semibold" style={{ color: colors.text }}>147</div>
                </div>
                <div className="p-2 rounded-lg flex flex-col gap-1" style={{ background: theme === 'light' ? '#F3F4F6' : '#1F2937' }}>
                  <div className="inline-flex items-center gap-1"><IoCardOutline className="h-3 w-3" /> AVG Value</div>
                  <div className="font-semibold" style={{ color: colors.text }}>$12</div>
                </div>
                <div className="p-2 rounded-lg flex flex-col gap-1" style={{ background: theme === 'light' ? '#F3F4F6' : '#1F2937' }}>
                  <div className="inline-flex items-center gap-1"><IoTimeOutline className="h-3 w-3" /> Peak Hour</div>
                  <div className="font-semibold" style={{ color: colors.text }}>5.00 PM</div>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="lg:col-span-7">
            <Card>
              <div className="flex items-center justify-between mb-3">
                <div className="text-sm font-semibold" style={{ color: colors.text }}>Recent Orders</div>
                <input placeholder="eg: search here..." className="rounded-full px-3 py-2 text-sm"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[0,1,2].map((i) => (
                  <div key={i} className="rounded-xl p-3" style={{ background: colors.background, border: `1px solid ${colors.cardBorder}` }}>
                    ...
                    <div className="text-sm font-semibold mb-1" style={{ color: colors.text }}>{['Beef Steak','Beef Burger','Special Pizza'][i]}</div>
                    <div className="text-xs mb-2" style={{ color: colors.mutedText }}>Order ID: #ORD-103{i}</div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs px-2 py-1 rounded" style={{ background: colors.green100, color: colors.green700 }}>Completed</span>
                      <span className="text-sm font-semibold" style={{ color: colors.text }}>${[15,35,50][i]}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-5 grid gap-4">
            <Card>
              <div className="text-sm font-semibold mb-2" style={{ color: colors.text }}>Employee status</div>
              <div className="h-36 flex items-center justify-center text-sm rounded-lg" style={{ background: theme === 'light' ? '#F5F7FA' : '#111827', color: colors.mutedText }}>Gauge placeholder</div>
            </Card>
            <Card>
              <div className="text-sm font-semibold mb-2" style={{ color: colors.text }}>Sales & Order Types</div>
